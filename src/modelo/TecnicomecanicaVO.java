 ...
 * @author SEBASTIAN
 */
public class TecnicomecanicaVO {
    ...
    public TecnicomecanicaVO(String codigo, String centroDiagnostico, Date fechaExpedicion, Date fechaVigente, String rutaFoto, String id_func, boolean estado) {
        this.codigo = codigo;
